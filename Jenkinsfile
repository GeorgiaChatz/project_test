                ...
                dir("${WORKSPACE_DIR}") {
                    script {
                        if (branchName == 'main') {
                            ...
                            '''
                            sh '''
                                sudo -u your_wsl_user screen -dmS streamlit_app_prod bash -c 'cd /workspace/streamlit-app && /home/wsl/.local/bin/streamlit run app.py > /workspace/streamlit_prod.log 2>&1'
